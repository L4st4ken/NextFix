                            ...
                            <nav class="-mx-3 flex flex-1 justify-end">
                                @auth
                                    @if (Auth::user()->usertype === 'admin')
                                        <a href="{{ url('/admin/dashboard') }}" class="sign-up-btn">Dashboard</a>
                                        
                                    @endif
                                    @if (Auth::user()-> usertype ==='staff')
                                      <a href="{{ url('/staff/dashboard') }}" class="sign-up-btn">Dashboard</a>
                                        
                                    @else
                                    <a href="{{ url('/dashboard') }}" class="sign-up-btn">Dashboard</a>
                                    @endif
