                ...
                <div class="overflow-hidden overflow-x-auto p-6 bg-white border-b border-gray-200">
                    <div class="min-w-full align-middle">
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                <form id="addUserForm" method="POST" action="{{ route('staff.movie.update', $movieId->id) }}">
                                    @csrf
                                    <div class="form-group row">
                                      <label for="userID" class="col-sm-2 col-form-label">Title</label>
                                      <div class="col-sm-10">
                                          <input type="text" name="title" class="form-control" id="userID" value="{{$movieId->title}}">
                                      </div>
                                  </div>
                                    <div class="form-group row">
                                      <label for="movieID" class="col-sm-2 col-form-label">Description</label>
                                      <div class="col-sm-10">
                                          <input type="text"  name="description" class="form-control" id="movieID" value="{{$movieId->description}}">
                                      </div>
                                  </div>
                                    <div class="form-group row">
                                        <label for="staticEmail" class="col-sm-2 col-form-label">Genre</label>
                                        <div class="col-sm-10">
                                            <input type="text"  name="genre" class="form-control" id="staticEmail" value="{{$movieId->genre}}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="booking_date" class="col-sm-2 col-form-label">Release Date</label>
                                        <div class="col-sm-10">
                                            <input type="date" name="release_date" class="form-control datepicker" id="booking_date"max="2044-01-01" value="{{$movieId->release_date}}">
                                        </div>
                                    </div>
