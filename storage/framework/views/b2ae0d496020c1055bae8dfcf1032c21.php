            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="overflow-hidden overflow-x-auto p-6 bg-white border-b border-gray-200">
                    <div class="min-w-full align-middle">
                        <a class="btn btn-dark" href="<?php echo e(route('staff.movie.add')); ?>">Add Movie</a>
                                ...
                                <?php $__currentLoopData = $movies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="bg-white">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a class="btn btn-dark px-3 py-1 rounded-md mr-2" href="<?php echo e(route('staff.movie.edit', $movie->id)); ?>"> Edit </a>
                                            <a class="btn btn-dark px-3 py-1 rounded-md mr-2" href="<?php echo e(route('staff.movie.delete', $movie->id)); ?>"> Delete </a>
                                        </td>
                                    </tr>
...
<?php endif; ?>
<?php /**PATH C:\Users\Evan\fake3-app\resources\views//staff/movie/index.blade.php ENDPATH**/ ?>