                ...
                <div class="overflow-hidden overflow-x-auto p-6 bg-white border-b border-gray-200">
                    <div class="min-w-full align-middle">
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                <form id="addUserForm" method="POST" action="<?php echo e(route('staff.movie.insert')); ?>">
                                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
  <?php /**PATH C:\Users\Evan\fake3-app\resources\views//staff/movie/insert.blade.php ENDPATH**/ ?>