...
<div class="row">
    <div class="col-6">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form id="addUserForm" method="POST" action="{{ route('booking.destroy', $booking->id) }}">
                    @csrf
                    @method('DELETE')
                    <div class="form-group row">
                      <label for="userID" class="col-sm-2 col-form-label">User ID</label>
                      <div class="col-sm-10">
                          <input type="text"  readonly name="user_id" class="form-control" id="userID" value="{{ $booking->user_id }}">
                      </div>
                  </div>
                    <div class="form-group row">
                      <label for="movieID" class="col-sm-2 col-form-label">Movie ID</label>
                      <div class="col-sm-10">
                          <input type="text"  readonly name="movie_id" class="form-control" id="movieID" value="{{ $booking->movie_id }}">
                      </div>
                  </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" readonly name="quantity" class="form-control" id="inputQty" value="{{$booking->quantity}}">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="datetime-local" readonly name="booking_date" class="form-control datepicker" id="booking_date" value="{{$booking->booking_date}}" min="2024-01-01" max="2044-01-01">
                        </div>
                    </div>
