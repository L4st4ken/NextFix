        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="<?php echo e(Auth::user()->usertype === 'staff' ? route('staff.dashboard') : route('dashboard')); ?>">
                        <img src="https://i.pinimg.com/736x/6e/e9/21/6ee92145d49b98d6f9c0b1545e574c05.jpg" width="37px"/>
                    </a>
                </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.nav-link','data' => ['href' => Auth::user()->usertype === 'staff' ? route('staff.dashboard') : route('dashboard'),'active' => request()->routeIs('dashboard')|| request()->routeIs('staff.dashboard')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(Auth::user()->usertype === 'staff' ? route('staff.dashboard') : route('dashboard')),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('dashboard')|| request()->routeIs('staff.dashboard'))]); ?>
...
<?php /**PATH C:\Users\Evan\fake3-app\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>